 ################################################################################  
    ...
    #DLfsVWfw#758Arrow
    #KZwaJNgf@294King
    #LRywGRcg!183King --> Jerry Derango
    #TUgpBWri$472demo --> password for SQL server autentication: ID: MANUFHQ
    #SXtiKFch$784sled --> password for Managed SQL 01 admin: epicadmin